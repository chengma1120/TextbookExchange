...
<div id="site">
    ...
    <div id="nav_main" role="navigation" class="reset menu pull_out">
        <ul>
            ...
            <li><a href="designers(2).php"><span>E-H</span></a></li>
            <li><a href="designers(3).php"><span>I-L</span></a></li>
            <li><a href="designers(4).php"><span>M-P</span></a></li>
            <li> <a href="designers(5).php"><span>Q-T</span></a>
            </li>
    ...
    <div id="content">
        ...
        <div id="no_col_1" role="main">
            <h1 class="inline_block">Available Textbooks</h1>
            <h2 class="h3 inline_block">From Current Duke Students</h2>
            <p>Click on the alphabet range for the subject you are looking for.</p>
            <div class="section">
                <center>
                <ul class="reset tiles">
                    <li> 
                        ...
                        <li><a href="#">BIOCHEM</a></li>
                        <li><a href="#">BME</a></li>
                <li><a href="bouquet.php">CHEM</a></li>
                        <LI><a href="#">CHINESE</a></li>
